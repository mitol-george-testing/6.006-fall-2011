...
| 2 | Models of computation, Python cost model, document distance | 1, 3, [Python Cost Model]({{< baseurl >}}/pages/readings/python-cost-model) |
...
| 5 | Binary search trees, BST sort | 10.4, 12.1–12.3, [Binary Search Trees]({{< baseurl >}}/pages/readings/binary-search-trees) |
